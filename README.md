...
<table width="100%">
  <tr height="187px">
    <td align="center" width="33%">
      <a href="https://go.clerk.com/zGlzydF">
        <picture>
          <source media="(prefers-color-scheme: dark)" srcset="https://github.com/BusinessBuilders/SaasSite/assets/1328388/6fb61971-3bf1-4580-98a0-10bd3f1040a2">
          <source media="(prefers-color-scheme: light)" srcset="https://github.com/BusinessBuilders/SaasSite/assets/1328388/f80a8bb5-66da-4772-ad36-5fabc5b02c60">
          <img alt="Clerk – Authentication & User Management for Next.js" src="https://github.com/BusinessBuilders/SaasSite/assets/1328388/f80a8bb5-66da-4772-ad36-5fabc5b02c60">
        </picture>
      </a>
    </td>
    <td align="center" width="33%">
  ...
  <tr height="187px">
    <td align="center" width="33%">
      <a href="mailto:donovan@business-builder.online">
        Add your logo here
      </a>
    </td>
  </tr>
...
**Live demo: [SaaS Boilerplate](https://business-builder.online)**

| Landing Page | User Dashboard |
| --- | --- |
| [![Next.js Boilerplate SaaS Landing Page](public/assets/images/nextjs-boilerplate-saas-landing-page.png)](https://react-saas.com) | [![Next.js Boilerplate SaaS User Dashboard](public/assets/images/nextjs-boilerplate-saas-user-dashboard.png)](https://business-builder.online/dashboard) |

| Team Management | User Profile |
| --- | --- |
| [![Next.js Boilerplate SaaS Team Management](public/assets/images/nextjs-boilerplate-saas-multi-tenancy.png)](https://business-builder.online/dashboard/organization-profile/organization-members) | [![Next.js Boilerplate SaaS User Profile](public/assets/images/nextjs-boilerplate-saas-user-profile.png)](https://business-builder.online/dashboard/user-profile) |

| Sign Up | Sign In |
| --- | --- |
| [![Next.js Boilerplate SaaS Sign Up](public/assets/images/nextjs-boilerplate-saas-sign-up.png)](https://business-builder.online/sign-up) | [![Next.js Boilerplate SaaS Sign In](public/assets/images/nextjs-boilerplate-saas-sign-in.png)](https://business-builder.online/sign-in) |
...
```shell
git clone --depth=1 https://github.com/BusinessBuilders/SaasSite
cd my-project-name
npm install
```
