...
export const CookieBanner = () => {
  ...
  return (
    <div
      ...
      className="bg-bb-black-soft/95 fixed inset-x-0 bottom-0 z-50 border-t border-bb-umber p-4 backdrop-blur"
    >
      <div className="mx-auto flex max-w-5xl flex-col items-start gap-3 sm:flex-row sm:items-center sm:justify-between">
        <p className="text-sm leading-relaxed text-bb-taupe">
          ...
          {' '}
          We
          use cookies to run the site and measure performance. Marketing cookies
